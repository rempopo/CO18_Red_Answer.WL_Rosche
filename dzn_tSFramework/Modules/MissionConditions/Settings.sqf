...
MissionCondition1 = [ "WIN1", {[ TRG_ART, "west", "", "< 2"] call dzn_fnc_ccUnits && [ TRG_1, "west", "", "< 2"] call dzn_fnc_ccUnits && !isNil "DATASecured"}, "All objectives done", 120 ];
MissionCondition1 = [ "WIN2", {[ TRG_ART, "west", "", "< 2"] call dzn_fnc_ccUnits && [ TRG_1, "west", "", "< 2"] call dzn_fnc_ccUnits}, "Main objectives done", 120 ];
