 ...
 */
[] spawn {
waitUntil {!isNil "ART_1"};
[[east, "HQ"], "Миномётный обстрел, в укрытие!"] remoteExec ["sideChat", 0];
[Mortar1, bomb1, "", 15, 5, 200] execVM "arty.sqf";		
};
[] spawn {
waitUntil {!isNil "ART_2"};
[[east, "HQ"], "Миномётный обстрел, в укрытие!"] remoteExec ["sideChat", 0];
[Mortar2, bomb2, "", 15, 5, 250] execVM "arty.sqf";		
};
